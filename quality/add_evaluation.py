...
# Version:      1.1.0 - FIXED
# Date:         2026-03-25
# Description:  QC Report Viewer - Safe formatting for timedelta
# =============================================================================
...
def show_evaluation_details(result_id):
    ...
    print(f"\n📞 CALL INFORMATION:")
    print(f"  • Agent: {h.get('agent_name', h.get('agent', 'Unknown'))} ({h.get('agent', 'Unknown')})")
...
def show_evaluations_list(agent=None, start_date=None, end_date=None, limit=50):
    """Show list of evaluations - FIXED safe formatting for timedelta"""
    ...
    for r in results:
        ...
        if isinstance(eval_time, timedelta):
            total_seconds = int(eval_time.total_seconds())
        ...
        print_color(f"{score}%", score_color, end=False)
...
def report_viewer_menu():
    ...
    while True:
        ...
        print("\nThis tool allows you to retrieve and view old QC evaluations.")
